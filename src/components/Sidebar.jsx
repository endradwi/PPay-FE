  ...
  return (
    ...
    {props.side === "sidebar" && 
      ...
      <main className="flex md:hidden px-5 py-6 text-sm justify-between items-center text-gray-600 bg-white border-r border-gray-200 border-solid w-full flex-shrink-0 font-montserrat shadow-lg h-full">
        ...
        <button className="h-10 items-center mt-2 pl-2 flex flex-col rounded-md text-red-600 focus:border-l-4 focus:border-red-600 focus:border-solid focus:bg-red-600 focus:bg-opacity-10">
