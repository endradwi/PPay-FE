    ...
    {props.side === "sidebar" && 
      <main className="hidden md:inline-block px-5 py-6 text-sm text-gray-600 bg-white border-r border-gray-200 border-solid w-[261px] flex-shrink-0 font-montserrat shadow-lg h-screen">
        <div className="inline-block w-full">
          ...
          <button onClick={()=> setShow(!isShow)} className="w-full h-10 items-center mt-2 pl-2 flex rounded-md text-red-600 focus:border-l-4 focus:border-red-600 focus:border-solid focus:bg-red-600 focus:bg-opacity-10">
      ...
      {isShow && <div className="w-96 h-96 top-[15rem] left-[50rem] absolute bg-white rounded-2xl flex flex-col justify-center items-center gap-10 shadow-xl">
        <div><BsFillQuestionCircleFill className="w-32 h-32 text-primary"/></div>
        <div className="flex gap-10">
          <Link to="/"><div className="cursor-pointer btn border border-info py-3 px-10 hover:bg-primary hover:border-0 hover:text-neutral rounded-xl">Yes</div></Link>
          <div onClick={()=>setShow(!isShow)} className="cursor-pointer btn bg-warning text-neutral border hover:text-black hover:border-warning py-3 px-10 rounded-xl">No</div>
        </div>
          </div>}
      {props.side !== "sidebar" && 
      <main className="flex md:hidden px-5 py-6 text-sm justify-between items-center text-gray-600 bg-white border-r border-gray-200 border-solid w-full flex-shrink-0 font-montserrat shadow-lg h-full">
        ...
        <button onClick={() => setShow(!isShow)} className="h-10 items-center mt-2 pl-2 flex flex-col rounded-md text-red-600 focus:border-l-4 focus:border-red-600 focus:border-solid focus:bg-red-600 focus:bg-opacity-10">
