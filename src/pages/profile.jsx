               ...
               <div className='flex gap-5 items-center'>
                   <div className=" avatar">
                     ...
                     <div className='flex flex-col gap-4'>
                        <div>
                            <button className='justify-center items-center rounded-lg w-40 h-11 bg-[#2948FF] text-white flex gap-2'><TbEdit className='w-6 h-6'/> Change Profile</button>
                        </div>
                        <div>
                            <button className='justify-center items-center rounded-lg border border-[#D00000] text-[#D00000] w-40 h-11 flex gap-2'><AiOutlineDelete className='w-6 h-6'/> Delete Profile</button>
                        </div>
                     </div>
                </div>
